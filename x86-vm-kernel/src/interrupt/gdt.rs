...
pub const USER_CODE_SEL: SegmentSelector = SegmentSelector::new(3, PrivilegeLevel::Ring3);
pub const USER_DATA_SEL: SegmentSelector = SegmentSelector::new(4, PrivilegeLevel::Ring3);
